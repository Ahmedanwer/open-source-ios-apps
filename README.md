...
The SDK removed the hassle of debugging by automatically attaching screen recordings, device details, network logs and repro-steps with each report to help you speed up the development process. [**Learn more.**](https://try.instabug.com/ios/?utm_source=opensourceios&utm_medium=spon&utm_content=learnmore)🚀
